/*
  Minimal seed for Hyper Context DB to validate schema wiring
  - 1 project with a tiny knowledge tree
  - 1 published stable version with frozen tree + contents
*/
...
async function main() {
  ...
  // Link stable version to project
